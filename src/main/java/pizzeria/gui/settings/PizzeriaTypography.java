...
public class PizzeriaTypography {
    ...
    public static final Font PLAIN_PARAGRAPH_FONT = new Font(Font.SANS_SERIF, Font.PLAIN, 12);
    public static final Font BOLD_PARAGRAPH_FONT = new Font(Font.SANS_SERIF, Font.BOLD, 13);
